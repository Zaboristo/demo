...
public class LambdaVariables {
    ...
    public static final String COGNITO = PREFIX + "simple-booking-userpool" + SUFFIX;
    public static final String COGNITO_CLIENT_API = PREFIX + "task10_app_client_id" + SUFFIX;
