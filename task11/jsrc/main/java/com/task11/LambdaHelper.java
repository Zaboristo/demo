...
import static com.task11.LambdaVariables.COGNITO_CLIENT_API;
import static com.task11.LambdaVariables.*;
...
public class LambdaHelper {
    ...
    public static <ScanResult> List<Map<String, Object>> getAllTables(AmazonDynamoDB dynamoDb, ScanRequest scanRequest) {
